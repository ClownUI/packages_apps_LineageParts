...
public class StatsUploadJobService extends JobService {
    ...
    private static final String TAG = "clownStats";
    private static final boolean DEBUG = true;

    public static final String KEY_JOB_TYPE = "job_type";
    public static final int JOB_TYPE_CLOWN = 1;
    ...
    private boolean uploadToClown(JSONObject json) throws IOException {
        final Uri uri = Uri.parse(getString(R.string.stats_clown_url));
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, "clown server response code=" + responseCode);
